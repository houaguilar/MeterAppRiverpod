              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomAddFloor(formKey1: _formKeyDescriptionPiso3, formKey2: _formKeyLargoPiso3, formKey3: _formKeyAnchoPiso3, formKey4: _formKeyAlturaPiso3, visibility: addPiso2, piso: "Piso 3", descriptionController: _descriptionPiso3Controller, largoController: _largoPiso3Controller, anchoController: _anchoPiso3Controller, alturaController: _alturaPiso3Controller, buttonVisibility: addPiso3, pressed: () => ref.read(addPiso3Provider.notifier).toggleAddPiso(),),
                    CustomAddFloor(formKey1: _formKeyDescriptionPiso4, formKey2: _formKeyLargoPiso4, formKey3: _formKeyAnchoPiso4, formKey4: _formKeyAlturaPiso4, visibility: addPiso3, piso: "Piso 4", descriptionController: _descriptionPiso4Controller, largoController: _largoPiso4Controller, anchoController: _anchoPiso4Controller, alturaController: _alturaPiso4Controller, buttonVisibility: addPiso4, pressed: () => ref.read(addPiso4Provider.notifier).toggleAddPiso(),),
                    CustomAddFloor(formKey1: _formKeyDescriptionPiso5, formKey2: _formKeyLargoPiso5, formKey3: _formKeyAnchoPiso5, formKey4: _formKeyAlturaPiso5, visibility: addPiso4, piso: "Piso 5", descriptionController: _descriptionPiso5Controller, largoController: _largoPiso5Controller, anchoController: _anchoPiso5Controller, alturaController: _alturaPiso5Controller, buttonVisibility: addPiso5, pressed: () => ref.read(addPiso5Provider.notifier).toggleAddPiso(),),
                    CustomAddFloor(formKey1: _formKeyDescriptionPiso6, formKey2: _formKeyLargoPiso6, formKey3: _formKeyAnchoPiso6, formKey4: _formKeyAlturaPiso6, visibility: addPiso5, piso: "Piso 6", descriptionController: _descriptionPiso6Controller, largoController: _largoPiso6Controller, anchoController: _anchoPiso6Controller, alturaController: _alturaPiso6Controller, buttonVisibility: addPiso6, pressed: () => ref.read(addPiso6Provider.notifier).toggleAddPiso(),),
                    CustomAddFloor(formKey1: _formKeyDescriptionPiso7, formKey2: _formKeyLargoPiso7, formKey3: _formKeyAnchoPiso7, formKey4: _formKeyAlturaPiso7, visibility: addPiso6, piso: "Piso 7", descriptionController: _descriptionPiso7Controller, largoController: _largoPiso7Controller, anchoController: _anchoPiso7Controller, alturaController: _alturaPiso7Controller, buttonVisibility: addPiso7, pressed: () => ref.read(addPiso7Provider.notifier).toggleAddPiso(),),
                    const SizedBox(height: 20,)
                  ],
                ),
              ),
