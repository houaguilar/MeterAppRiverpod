...
import 'package:app_with_riverpod/presentation/screens/widgets/shared/custom_add_three_fields.dart';
...
class DatosVigasScreen extends ConsumerStatefulWidget {
  const DatosVigasScreen({Key? key}) : super(key: key);
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomAddThreeFields(formKey1: _formKeyDescriptionViga2, formKey2: _formKeyLargoViga2, formKey3: _formKeyAnchoViga2, firstNameTextController: 'Descripción', secondNameTextController: 'Largo', thirdNameTextController: 'Ancho', visibility: addViga1, titleMaterial: "Viga 2", firstTextController: _descriptionViga2Controller, secondTextController: _largoViga2Controller, thirdTextController: _anchoViga2Controller, firstHintText: 'ej. viga de la cocina', secondHintText: 'metros', thirdHintText: 'metros', buttonVisibility: addViga2, pressed: () => ref.read(addMuroBloqueta2Provider.notifier).toggleAddMuro(), nameAddMaterial: 'Agregar Viga', pressedCancel: () { ref.read(addMuroBloqueta1Provider.notifier).toggleAddMuro();},),
                    CustomAddThreeFields(formKey1: _formKeyDescriptionViga3, formKey2: _formKeyLargoViga3, formKey3: _formKeyAnchoViga3, firstNameTextController: 'Descripción', secondNameTextController: 'Largo', thirdNameTextController: 'Ancho', visibility: addViga2, titleMaterial: "Viga 3", firstTextController: _descriptionViga3Controller, secondTextController: _largoViga3Controller, thirdTextController: _anchoViga3Controller, firstHintText: 'ej. viga de la cocina', secondHintText: 'metros', thirdHintText: 'metros', buttonVisibility: addViga3, pressed: () => ref.read(addMuroBloqueta3Provider.notifier).toggleAddMuro(), nameAddMaterial: 'Agregar Viga', pressedCancel: () { ref.read(addMuroBloqueta2Provider.notifier).toggleAddMuro();},),
                    CustomAddThreeFields(formKey1: _formKeyDescriptionViga4, formKey2: _formKeyLargoViga4, formKey3: _formKeyAnchoViga4, firstNameTextController: 'Descripción', secondNameTextController: 'Largo', thirdNameTextController: 'Ancho', visibility: addViga3, titleMaterial: "Viga 4", firstTextController: _descriptionViga4Controller, secondTextController: _largoViga4Controller, thirdTextController: _anchoViga4Controller, firstHintText: 'ej. viga de la cocina', secondHintText: 'metros', thirdHintText: 'metros', buttonVisibility: addViga4, pressed: () => ref.read(addMuroBloqueta4Provider.notifier).toggleAddMuro(), nameAddMaterial: 'Agregar Viga', pressedCancel: () { ref.read(addMuroBloqueta3Provider.notifier).toggleAddMuro();},),
                    CustomAddThreeFields(formKey1: _formKeyDescriptionViga5, formKey2: _formKeyLargoViga5, formKey3: _formKeyAnchoViga5, firstNameTextController: 'Descripción', secondNameTextController: 'Largo', thirdNameTextController: 'Ancho', visibility: addViga4, titleMaterial: "Viga 5", firstTextController: _descriptionViga5Controller, secondTextController: _largoViga5Controller, thirdTextController: _anchoViga5Controller, firstHintText: 'ej. viga de la cocina', secondHintText: 'metros', thirdHintText: 'metros', buttonVisibility: addViga5, pressed: () => ref.read(addMuroBloqueta5Provider.notifier).toggleAddMuro(), nameAddMaterial: 'Agregar Viga', pressedCancel: () { ref.read(addMuroBloqueta4Provider.notifier).toggleAddMuro();},),
                    CustomAddThreeFields(formKey1: _formKeyDescriptionViga6, formKey2: _formKeyLargoViga6, formKey3: _formKeyAnchoViga6, firstNameTextController: 'Descripción', secondNameTextController: 'Largo', thirdNameTextController: 'Ancho', visibility: addViga5, titleMaterial: "Viga 6", firstTextController: _descriptionViga6Controller, secondTextController: _largoViga6Controller, thirdTextController: _anchoViga6Controller, firstHintText: 'ej. viga de la cocina', secondHintText: 'metros', thirdHintText: 'metros', buttonVisibility: addViga6, pressed: () => ref.read(addMuroBloqueta6Provider.notifier).toggleAddMuro(), nameAddMaterial: 'Agregar Viga', pressedCancel: () { ref.read(addMuroBloqueta5Provider.notifier).toggleAddMuro();},),
                    CustomAddThreeFields(formKey1: _formKeyDescriptionViga7, formKey2: _formKeyLargoViga7, formKey3: _formKeyAnchoViga7, firstNameTextController: 'Descripción', secondNameTextController: 'Largo', thirdNameTextController: 'Ancho', visibility: addViga6, titleMaterial: "Viga 7", firstTextController: _descriptionViga7Controller, secondTextController: _largoViga7Controller, thirdTextController: _anchoViga7Controller, firstHintText: 'ej. viga de la cocina', secondHintText: 'metros', thirdHintText: 'metros', buttonVisibility: addViga7, pressed: () => ref.read(addMuroBloqueta7Provider.notifier).toggleAddMuro(), nameAddMaterial: 'Agregar Viga', pressedCancel: () { ref.read(addMuroBloqueta6Provider.notifier).toggleAddMuro();},),
