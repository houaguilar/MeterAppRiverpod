...
class DatosLosasAligeradasScreen extends ConsumerStatefulWidget {
  const DatosLosasAligeradasScreen({Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    SizedBox(
                      child: CommonTextFormField(
                        formKey: _formKeyDescriptionLosaAligerada1, description: 'Descripción' ,controller: _descriptionLosaAligerada1Controller, hintText: 'ej. Losa de la cocina', isKeyboardText: true,),),
                    SizedBox(
                      child: CommonTextFormField(
