...
class DatosLosasMacizasScreen extends ConsumerStatefulWidget {
  const DatosLosasMacizasScreen({Key? key}) : super(key: key);
...
class _DatosLosasMacizasScreenState extends ConsumerState<DatosLosasMacizasScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final addLosaMaciza1 = ref.watch(addMuroBloqueta1Provider);
    final addLosaMaciza2 = ref.watch(addMuroBloqueta2Provider);
    final addLosaMaciza3 = ref.watch(addMuroBloqueta3Provider);
    final addLosaMaciza4 = ref.watch(addMuroBloqueta4Provider);
    final addLosaMaciza5 = ref.watch(addMuroBloqueta5Provider);
    final addLosaMaciza6 = ref.watch(addMuroBloqueta6Provider);
    final addLosaMaciza7 = ref.watch(addMuroBloqueta7Provider);
